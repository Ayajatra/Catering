<%@ Page Title="Edit Food" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditFood.aspx.cs" Inherits="Catering.Views.EditFood" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="mx-auto bg-gray-200 rounded py-4 px-7" style="width: 440px;">
        <h1 class="text-center text-3xl text-bold">Edit Food Food</h1>
        ...
        <asp:Button ID="ButtonEdit" Text="Edit" OnClick="ButtonEdit_Click" CssClass="block w-full py-3 bg-yellow-400 text-white" runat="server" />
    </div>
